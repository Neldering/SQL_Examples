            ...
            <div id="inner-content">
                <div id="Medications">
                    ...
                    <div class="panel panel-default">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php
                            foreach (MedService::Instance()->getAllMeds() as $doc) {
                                echo '<tr>';
                                echo '<td>' . $doc["Med_ID"] . '</td>';
                                echo '<td>' . $doc["Med_Name"] . '</td>';
                                echo '<td>' . $doc["Inventory"] . '</td>';
                                echo '<td>
                                        ...
                                        <input type="hidden" name="med-id" value="' . $doc["Med_ID"] . '" />
                ...
                <div id="new-Medication">
                    ...
                    <form id="newCustomerForm" method="POST" action="controllers/med/CreateMed.php">
                        ...
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-secondary align-items-center">Create Medication</button>
                        </div>
                    </form>
                </div>
            </div>
