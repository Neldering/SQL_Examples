...
<html>
<head>
<title>Prescription List by Doctor</title>
...
$query = 'SELECT  Doc.Doctor_ID, Doc.Doctor_Name, Pre.Prescription_ID, customer.Customer_Name, med.Med_Name, Pre.Refill_Amount, Pre.Date_Writen
